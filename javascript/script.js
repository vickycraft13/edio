...
$("#simulate").click(function () {
  ...
  setTimeout(function () {
    ...
    if (frameout == "ECU") {
      ...
      $(".prev").remove();
      $("#video1").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./Animation/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./ExtremeCloseUp/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./BigCloseUp/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./CloseUp/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./MediumCloseUp/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='t-2' width='728' height='auto' muted autoplay loop> <source src='./MediumShot/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./FullShot/" +
          angleout +
          "-" +
          frameout +
          "-" +
      ...
      $("#video2").append(
        "<video class='mt-2' width='728' height='auto' muted autoplay loop> <source src='./LongShot/" +
          angleout +
          "-" +
          frameout +
          "-" +
